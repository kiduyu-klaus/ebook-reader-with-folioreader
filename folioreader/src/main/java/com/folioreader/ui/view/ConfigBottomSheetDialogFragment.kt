...
class ConfigBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    private val view_config_ib_day_mode get() = requireView().findViewById<ImageButton>(R.id.view_config_ib_day_mode)
    private val view_config_ib_night_mode get() = requireView().findViewById<ImageButton>(R.id.view_config_ib_night_mode)
    private val view_config_font_andada get() = requireView().findViewById<TextView>(R.id.view_config_font_andada)
    private val view_config_font_lato get() = requireView().findViewById<TextView>(R.id.view_config_font_lato)
    private val view_config_font_lora get() = requireView().findViewById<TextView>(R.id.view_config_font_lora)
    private val view_config_font_raleway get() = requireView().findViewById<TextView>(R.id.view_config_font_raleway)
    private val view_config_font_size_seek_bar get() = requireView().findViewById<SeekBar>(R.id.view_config_font_size_seek_bar)
    private val buttonVertical get() = requireView().findViewById<TextView>(R.id.buttonVertical)
    private val buttonHorizontal get() = requireView().findViewById<TextView>(R.id.buttonHorizontal)
    private val container get() = requireView().findViewById<View>(R.id.container)
    private val view5 get() = requireView().findViewById<View>(R.id.view5)
